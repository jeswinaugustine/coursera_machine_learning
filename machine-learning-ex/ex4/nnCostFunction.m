...
% Reshape nn_params back into the parameters Thettemp1and Theta2, the weight matrices
...
%         the cost function with respect to Thettemp1and Thettemp2 in Theta1_grad and
